...
log = open('final_cause_pair_extraction_log_' + timestr + '.txt', 'w', buffering=1)
sys.stdout = log
sys.stderr = log
    ...
    for epoch in range(1, epochs + 1):
        ...
        with torch.no_grad():
            for iteration, batch in enumerate(test_loader):
                ...
                print("\ncurrent test cause precision: {:.4f}, recall: {:.4f}, f1 socre: {:.4f}".format(p, r, f1))
