...
parser.add_argument('--source_domain', default='history', help='zh-society, en-history')
parser.add_argument('--target_domain', default='adventure_new', help='zh-finance, education, entertainment and home, en-war, romance, adventure and biography')
...
if opt.language == 'zh':
    log = open('zh_final_emotion_extraction_log_' + timestr + '.txt', 'w', buffering=1)
elif opt.language == 'en':
    opt.training_epoch = 15
    log = open('en_final_emotion_extraction_log_' + timestr + '.txt', 'w', buffering=1)
sys.stdout = log
sys.stderr = log
...
def generate_self_train_data(source_data, best_pred):
    ...
    if opt.language == 'zh':
        ...
        self_train = "domains/Englishnovel_multiple/" + opt.target_domain + ".txt"
