...
if opt.language == 'zh':
    log = open('zh_final_cause_pair_extraction_mul_memorization_log_' + timestr + '.txt', 'w', buffering=1)
elif opt.language == 'en':
...
plt.legend(loc='best')
plt.savefig("memorization_final_mul_fix_neg_"+opt.target_domain+".png")
