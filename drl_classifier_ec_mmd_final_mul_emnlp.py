...
parser.add_argument('--target_domain', default='finance',
...
parser.add_argument('--adapter', default='entmax', help='using adapter or not, false refer to not using adapter, '
...
parser.add_argument('--confounding', type=str, default='true', help='using confounding mode in the model')
