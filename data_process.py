...
def acc_prf(pred_y, true_y, doc_len, average='micro'):
    tmp1, tmp2 = [], []
    ...
    p = precision_score(y_true, y_pred, average=average, labels=[0, 1, 2, 3, 4, 5])
    r = recall_score(y_true, y_pred, average=average, labels=[0, 1, 2, 3, 4, 5])
    f1 = f1_score(y_true, y_pred, average=average, labels=[0, 1, 2, 3, 4, 5])
    return p, r, f1
